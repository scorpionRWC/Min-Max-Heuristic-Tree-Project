...
void Morris::testList(char board[], int levels, string output)
{
    ...
    for (int r = 0; r < 23; r++)
    {
        if (board[r] == 'W') board[r] = 'B';
        else if (board[r] == 'B') board[r] = 'W';
    }
    ...
    while (root->currentSibling != NULL)
    {
        ...
        for (int x = 0; x < 23; x++)
        {
            if (root->currentSibling->boardB[x] == 'W') cout << 'B';
            else if (root->currentSibling->boardB[x] == 'B') cout << 'W';
            else cout << 'x';
        }
        cout << endl;
        leaves = 0;
        ...
        if (temp > bestEstimate)
        {
            ...
            for (int i = 0; i < 23; i++)
            {
                if (root->currentSibling->boardB[i] == 'W') bestBoard[i] = 'B';
                else if (root->currentSibling->boardB[i] == 'B') bestBoard[i] = 'W';
                else bestBoard[i] = 'x';
            }
        }
